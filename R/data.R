...
#' \describe{
#'    \item{cna}{a matrix with 20264 rows and 444 columns, of the Copy Number Alteration of the 444 tumor samples}
...
#'   \item{cna}{matrix with 21723 rows and 109 columns, for the Copy Number Alteration data}
...
#'   \item{cna}{matrix with 22431 rows and 65 columns}
...
#'   \item{cna}{matrix with 21735 rows and 333 columns}
#'   \item{xcell}{matrix with 39 rows and 333 columns}
...
#'  \item{mcp){matrix with 11 rows and 838 columns, the mcp deconvolution of the expression data}
#'  \item{quantiseq){matrix with 11 rows and 838 columns, the quantisec deconvolution of the expression data}
