...
osf_data_2 <- curatedPCaData:::seperate_osf(osf_data)
#save(osf_data_2, file="data-raw/osf_data_2.RData")
osf_data_t <- curatedPCaData:::rearrange(osf_data_2)
dropped_results1 <- curatedPCaData:::keep_only_PRAD(PRAD_osf)
