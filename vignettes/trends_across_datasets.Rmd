...
The volcano_plot_matrix function below is used to create a matrix with the logFC and FDR values required to generate the volcano plots. 
...
We can now use the function defined above to create the matrices for all the datasets as shown below
```{r,results=FALSE,eval=FALSE}
...
plot<-ggplot(data=df_tcga, aes(x=logfc, y=-log10(fdr), color=gene,size=1)) +
  ...
  guides(size = "none")+ ggtitle("TCGA")+ theme(plot.title = element_text(hjust = 0.5))
...
plot<-ggplot(data=df_taylor, aes(x=logfc, y=-log10(fdr), color=gene,size=1)) +
  ...
  gghighlight(!is.na(gene), use_direct_label = FALSE,unhighlighted_params=list(size=1))+
  theme_minimal() + theme_bw() + theme_classic()+
  guides(size = "none")+ ggtitle("Taylor")+ theme(plot.title = element_text(hjust = 0.5))
...
plot<-ggplot(data=df_friedrich, aes(x=logfc, y=-log10(fdr), color=gene,size=1)) +
  ...
  gghighlight(!is.na(gene), use_direct_label = FALSE,unhighlighted_params=list(size=1))+
  theme_minimal() + theme_bw() + theme_classic()+
  guides(size = "none")+ ggtitle("Friedrich")+ theme(plot.title = element_text(hjust = 0.5))
...
plot<-ggplot(data=df_igc, aes(x=logfc, y=-log10(pval), color=gene,size=1)) +
  geom_point() +
  gghighlight(!is.na(gene), use_direct_label = FALSE,unhighlighted_params=list(size=1))+
  theme_minimal() + theme_bw() + theme_classic()+guides(size = "none")+ ggtitle("IGC")+ theme(plot.title = element_text(hjust = 0.5))
...
plot<-ggplot(data=df_weiner, aes(x=logfc, y=-log10(fdr), color=gene,size=1)) +
  geom_point() +
  gghighlight(!is.na(gene), use_direct_label = FALSE,unhighlighted_params=list(size=1))+
  theme_minimal() + theme_bw() + theme_classic()+guides(size = "none")+ ggtitle("Weiner")+ theme(plot.title = element_text(hjust = 0.5))
