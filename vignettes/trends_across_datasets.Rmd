...
The odds_ratio function below calculates the odds ratio for any binary alteration matrix where 1 stands for any alteration in copy number or mutations that are not silent, and 0 stands for no alteration.
```{r}
