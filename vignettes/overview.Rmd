...
overmat <- matrix("", ncol=4, nrow=length(multiomics))
colnames(overmat) <- c("GEX & CNA", "GEX & MUT", "CNA & MUT", "GEX & CNA & MUT")
...
for(mult in multiomics){
	...
	overmat[mult,] <- c(gex_cna, gex_mut, cna_mut, gex_cna_mut)
}
