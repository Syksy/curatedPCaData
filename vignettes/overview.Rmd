...
studies <- matrix(NA, nrow=nrow(dats), ncol=5)
colnames(studies) <- c("MAE-object", "Study name(s)", "GEX/CNA/MUT platform(s)", "Notes", "Reference(s)")
	
knitr::kable(studies, caption="Study characteristics")
