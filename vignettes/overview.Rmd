...
The purity scores were calculated using DeMixT [ref], and was available for the studies:
- ```mae_chandran```
- ```mae_friedrich```
- ```mae_kunderfranco```
- ```mae_taylor```
...
- ```Decipher``` [Herlemann et al.]
- ```Oncotype DX``` [Knezevic et al.]
- ```Prolaris``` [NICE Advice]

Further, the 12-gene Androgen Receptor (AR) score is calculated similar to [ref] and provided in this slot:
