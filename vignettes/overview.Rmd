...
Three primary clinical end-points were utilized and are offered in colData-slots in the MAE-objects:
...
The purity scores were calculated using DeMixT [Wang et al., 2018], and was available for the studies:
- ```mae_chandran```
- ```mae_friedrich```
- ```mae_kunderfranco```
- ```mae_taylor```
