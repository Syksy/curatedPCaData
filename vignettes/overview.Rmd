...
However, it should be noted that the package is built with the option `LazyData: true`, therefore all the `mae_*` objects will be available to the user by simply running `library(curatedPCaData)`.
