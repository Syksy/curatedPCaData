...
q_endo_xcell_taylor <- data.frame("AboveQuantile" = mae_taylor[["xcell"]]["Endothelial cell",samples_bcr_taylor] >= quantile(mae_taylor[["xcell"]]["Endothelial cell",samples_bcr_taylor], probs=c(2/3)))
q_endo_mcp_taylor <- data.frame("AboveQuantile" = mae_taylor[["mcp"]]["Endothelial cell",samples_bcr_taylor] >= quantile(mae_taylor[["mcp"]]["Endothelial cell",samples_bcr_taylor], probs=c(2/3)))
...
Similarly, an increasing trend in endothelial cell score is noticed in MCP counter with higher grade groups.
