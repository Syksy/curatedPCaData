...
```{r gleason_tcga, dpi=150, fig.width=7, fig.height=7, out.width="100%", fig.cap="Gleason score vs BCR (TCGA)"}
...
fit_gleason_tcga <- survfit(bcr_tcga ~ clin_tcga$gleason_grade)
ggsurvplot(fit_gleason_tcga, risk.table = TRUE, data = clin_tcga, pval=TRUE, title="TCGA BCR vs Gleason grades")
```

```{r gleason_taylor, dpi=150, fig.width=7, fig.height=7, out.width="100%", fig.cap="Gleason score vs BCR (Taylor et al.)"}
...
fit_gleason_taylor <- survfit(bcr_taylor ~ clin_taylor$gleason_grade)
ggsurvplot(fit_gleason_taylor, risk.table = TRUE, data = clin_taylor, pval=TRUE, title="Taylor et al. BCR vs Gleason grades")
```
...
ggsurvplot(fit_gleason_barwick, risk.table = TRUE, data = clin_barwick, pval=TRUE, title="Barwick et al. BCR vs Gleason grades")
```
...
```{r gleason_abida_death, dpi=150, fig.width=7, fig.height=7, out.width="100%", fig.cap="Gleason score vs OS (Abida et al.)"}
...
ggsurvplot(fit_gleason_abida, risk.table = TRUE, data = clin_abida, pval=TRUE, title="Abida et al. OS vs Gleason grades")
```
...
ggsurvplot(fit_metassite_abida, risk.table = TRUE, data = clin_abida, pval=TRUE, title="Abida et al. OS vs Metastasis site")
```
...
ggsurvplot(fit_erg_abida, risk.table = TRUE, data = clin_abida, pval=TRUE, title="Abida et al. OS vs ERG-fusion")
```
