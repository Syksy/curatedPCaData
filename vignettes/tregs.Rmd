...
## T reg (CIBERSORT) vs. Gleasons over multiple datasets

```{r,dpi=150, fig.width=7, fig.height=7, out.width="100%", fig.cap="Boxplots for T reg cells vs. Gleasons across multiple datasets"}

# Aggregate T-reg data over multiple datasets and visualize as boxplots using ggplot2
tregs <- as.data.frame(rbind(
...
p <- ggplot(tregs, aes(x=grade_group, y=value)) + geom_boxplot() + xlab("Gleason grade group") + ylab("T reg population (CIBERSORT)")
