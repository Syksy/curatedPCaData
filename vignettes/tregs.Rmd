...
tcga<-as.data.frame(mae_tcga[["gex.fpkm"]])
...
ggplot(foxp3_and_tregs, aes(x=condition_tregs, y=FOXP3))+geom_boxplot() +geom_jitter(color="black", size=0.4, alpha=0.9)+ylab("FOXP3 expression (TCGA)") 
...
ggplot(foxp3_and_tregs, aes(x=condition_tregs, y=FOXP3))+geom_boxplot() +geom_jitter(color="black", size=0.4, alpha=0.9)+ylab("FOXP3 expression (Taylor)") 
...
tcga_gex<-as.data.frame(mae_tcga[["gex.fpkm"]])
...
ggsurvplot(sfit,pval=TRUE, risk.table=TRUE,palette = "Dark2",xlab="Time (months)",title="FOXP3 vs BCR (TCGA)")
...
ggsurvplot(sfit,pval=TRUE, risk.table=TRUE,palette = "Dark2",xlab="Time (months)",title="FOXP3 vs BCR (Taylor)")
...
plot(tregs_and_foxp3$`T cells regulatory (Tregs)`,tregs_and_foxp3$FOXP3,xlab="T regulatory cells",ylab="FOXP3 Expression",title="Tregs vs FOXP3 expression (TCGA)")
