...
clinical<-weiner[,c("sample_name","grade_group")]
clinical<-clinical[!is.na(clinical$grade_group),]
#clinical<-clinical[!is.na(clinical$gleason_grade),]
...
tregs_cibersort <- as.data.frame(rbind(
	cbind(longFormat(mae_abida["T cells regulatory (Tregs)",,"cibersort"], colDataCols="grade_group"), dataset = "Abida et al."),
	cbind(longFormat(mae_barbieri["T cells regulatory (Tregs)",,"cibersort"], colDataCols="grade_group"), dataset = "Barbieri et al."),
	cbind(longFormat(mae_chandran["T cells regulatory (Tregs)",,"cibersort"], colDataCols="grade_group"), dataset = "Chandran et al."),
	cbind(longFormat(mae_friedrich["T cells regulatory (Tregs)",,"cibersort"], colDataCols="grade_group"), dataset = "Friedrich et al."),
	cbind(longFormat(mae_icgcca["T cells regulatory (Tregs)",,"cibersort"], colDataCols="grade_group"), dataset = "ICGC Canadian"),
	cbind(longFormat(mae_igc["T cells regulatory (Tregs)",,"cibersort"], colDataCols="grade_group"), dataset = "IGC"),
	cbind(longFormat(mae_kunderfranco["T cells regulatory (Tregs)",,"cibersort"], colDataCols="grade_group"), dataset = "Kunderfranco et al."),
	cbind(longFormat(mae_taylor["T cells regulatory (Tregs)",,"cibersort"], colDataCols="grade_group"), dataset = "Taylor et al."),
	cbind(longFormat(mae_tcga["T cells regulatory (Tregs)",,"cibersort"], colDataCols="grade_group"), dataset = "TCGA"),
	cbind(longFormat(mae_true["T cells regulatory (Tregs)",,"cibersort"], colDataCols="grade_group"), dataset = "True et al."),
	cbind(longFormat(mae_wallace["T cells regulatory (Tregs)",,"cibersort"], colDataCols="grade_group"), dataset = "Wallace et al.")
))
...
by(tregs_cibersort, INDICES=tregs_cibersort$dataset, FUN=function(dat){
	print(paste("====", unique(dat$dataset)[1], " / CIBERSORT ===="))
...
tregs_quantiseq <- as.data.frame(rbind(
	cbind(longFormat(mae_abida["T cell regulatory (Tregs)",,"quantiseq"], colDataCols="grade_group"), dataset = "Abida et al."),
	cbind(longFormat(mae_barbieri["T cell regulatory (Tregs)",,"quantiseq"], colDataCols="grade_group"), dataset = "Barbieri et al."),
	cbind(longFormat(mae_chandran["T cell regulatory (Tregs)",,"quantiseq"], colDataCols="grade_group"), dataset = "Chandran et al."),
	cbind(longFormat(mae_friedrich["T cell regulatory (Tregs)",,"quantiseq"], colDataCols="grade_group"), dataset = "Friedrich et al."),
	cbind(longFormat(mae_icgcca["T cell regulatory (Tregs)",,"quantiseq"], colDataCols="grade_group"), dataset = "ICGC Canadian"),
	cbind(longFormat(mae_igc["T cell regulatory (Tregs)",,"quantiseq"], colDataCols="grade_group"), dataset = "IGC"),
	cbind(longFormat(mae_kunderfranco["T cell regulatory (Tregs)",,"quantiseq"], colDataCols="grade_group"), dataset = "Kunderfranco et al."),
	cbind(longFormat(mae_taylor["T cell regulatory (Tregs)",,"quantiseq"], colDataCols="grade_group"), dataset = "Taylor et al."),
	cbind(longFormat(mae_tcga["T cell regulatory (Tregs)",,"quantiseq"], colDataCols="grade_group"), dataset = "TCGA"),
	cbind(longFormat(mae_true["T cell regulatory (Tregs)",,"quantiseq"], colDataCols="grade_group"), dataset = "True et al."),
	cbind(longFormat(mae_wallace["T cell regulatory (Tregs)",,"quantiseq"], colDataCols="grade_group"), dataset = "Wallace et al.")
))
...
by(tregs_quantiseq, INDICES=tregs_quantiseq$dataset, FUN=function(dat){
